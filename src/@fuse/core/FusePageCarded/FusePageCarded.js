			...
			<div className="flex container w-full">
				...
				>
					...
					<div className={clsx(classes.contentCard, props.innerScroll && 'inner-scroll')}>
						{props.contentToolbar && <div className={clsx(classes.toolbar)}>{props.contentToolbar}</div>}
						{props.moreToolbar && <div>{props.moreToolbar}</div>}
						{props.content && (
							<FuseScrollbars
								className={clsx(classes.content, 'scroll-top')}
