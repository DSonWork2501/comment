...
import GenMenu from 'app/fuse-layouts/shared-components/GenMenu';
import { navigationCustom } from 'app/fuse-configs/navigationConfig';
...
export const selectNavigationCustom = (authActions, limit = 8, itemLimit = 3) => createSelector(
	[selectNavigationAll, ({ i18n }) => i18n.language],
	(navigation, language) => {
		function setTranslationValues(data) {
			// loop through every object in the array
		...
		return setTranslationValues(_.merge([], GenMenu(navigation, navigationCustom, authActions, limit, itemLimit)));
	}
);
