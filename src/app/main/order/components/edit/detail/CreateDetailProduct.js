...
export default function CreateDetailProduct({ formik, handleSelectItem, handleSelectItemInList, handleChangeType }) {
    ...
    return (
        <ProductSlotSKUItem formik_entity={formik} formik={formik_item} keyStore={keyStore} HandleAddData={HandleAddData} handleSelectItem={handleSelectItem} handleSelectItemInList={handleSelectItemInList} handleChangeType={handleChangeType} />
    )
}