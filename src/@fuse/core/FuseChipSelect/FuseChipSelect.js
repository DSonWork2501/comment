...
function FuseChipSelect(props) {
	...
	return props.variant === 'fixed' ? (
		<Select classNamePrefix="fuse-chip-select" {...props} components={components} onChange={handleOnChange} isDisabled={props.disabled}/>
	) : (
		<Creatable classNamePrefix="fuse-chip-select" {...props} components={components} onChange={handleOnChange} isDisabled={props.disabled}/>
	);
}
