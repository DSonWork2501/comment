...
export const customModal = (item) => {
    return {
        "order": {
            ...
            "customercity": item.customercity?.name || item.cityname,
            "customerdistrict": item.customerdistrict?.name || item.districtname,
            "customerward": item.customerward?.name || item.wardname,
